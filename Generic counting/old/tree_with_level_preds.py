...
def prof():  
    ...
    coords = []
    alphas = [1,0,1,1]
    learning_rate0 = math.pow(10,-4)
    learn_intersections = True
    subsampling = False
    squared_hinge_loss = True
    test_imgs, train_imgs = get_seperation(sftp_client)
    X_p_test, y_p_test, investigate = get_data(sftp_client, class_, test_imgs, train_imgs, 12, 13, 'training', c)
    
    #[1,0,1,1] with squared_hinge_loss
    print '/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_%s_%s_b.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections,subsampling,squared_hinge_loss)
    with sftp_client.open('/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_%s_%s_b.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections,subsampling,squared_hinge_loss), 'rb') as handle:
        w = pickle.load( handle)
    with sftp_client.open('/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_%s_%s_b_scaler.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections,subsampling,squared_hinge_loss), 'rb') as handle:
        scaler = pickle.load( handle)
    
    #[1,0,1,1] without squared_hinge_loss
#    print '/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections)
#    with sftp_client.open('/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections), 'rb') as handle:
#        w = pickle.load( handle)
#    with sftp_client.open('/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_scaler.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections), 'rb') as handle:
#        scaler = pickle.load( handle)
    
    #[1,0,0,0]
#    print '/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_%s.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections,subsampling)
#    with sftp_client.open('/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_%s.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections,subsampling), 'rb') as handle:
#        w = pickle.load( handle)
#    with sftp_client.open('/home/stahl/Models/'+class_+c+'%s_%s_%s_%s_%s_%s_%s_scaler.pickle'%(learning_rate0, alphas[0],alphas[1],alphas[2],alphas[3],learn_intersections,subsampling), 'rb') as handle:
#        scaler = pickle.load( handle)
